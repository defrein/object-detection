...
def detect_color_target(frame):
    ...
    mask_red = cv2.inRange(hsv, colorLowerRed, colorUpperRed)
...
if __name__ == "__main__":
    ...
    colorLowerRed = np.array([135, 194, 62])
    colorUpperRed = np.array([255, 255, 255])
    # colorLowerRed2 = np.array([160, 100, 100])  # Rentang merah gelap di ujung spektrum
